(function () {
  ...
  function render() {
    ...
    for(var s = 0; s < shapes.children.length; s++) {
      ...
      // if(!resetting) {
      //   for ( var i = 0; i < shape.geometry.vertices.length; i ++ ) {
      //     shape.geometry.vertices[i].x = shape.verticesOrigin[i].x * (0.8 + noise.perlin3(shape.verticesOrigin[i].x, i, time) * 0.2);
      //     shape.geometry.vertices[i].y = shape.verticesOrigin[i].y * (0.8 + noise.perlin3(shape.verticesOrigin[i].y, i, time) * 0.2);
      //     shape.geometry.vertices[i].z = shape.verticesOrigin[i].z * (0.8 + noise.perlin3(shape.verticesOrigin[i].z, i, time) * 0.2);
    	// 	}
      // }
