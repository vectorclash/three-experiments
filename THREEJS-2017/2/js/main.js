...
function render() {
	...
	if(roughSphere) {
		for ( var i = 0; i < roughSphere.geometry.vertices.length; i ++ ) {
			roughSphere.geometry.vertices[i].x = roughSphere.verticesOrigin[i].x * 0.9 + (0.5 + noise.perlin3(roughSphere.verticesOrigin[i].x, 10, noise.perlin2(time1, 29)) * 1.5);
			roughSphere.geometry.vertices[i].y = roughSphere.verticesOrigin[i].y * 0.9 + (0.5 + noise.perlin3(roughSphere.verticesOrigin[i].y, 20, noise.perlin2(time2, 39)) * 1.5);
			roughSphere.geometry.vertices[i].z = roughSphere.verticesOrigin[i].z * 0.9 + (0.5 + noise.perlin3(roughSphere.verticesOrigin[i].z, 30, noise.perlin2(time3, 49)) * 1.5);
		}
